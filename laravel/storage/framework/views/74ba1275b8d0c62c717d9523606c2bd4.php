<?php $__env->startSection('css'); ?>
    ...
    <?php echo $__env->make('voyager::compass.includes.styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="tab-content">
            <div id="resources" class="tab-pane fade in <?php if(empty($active_tab) || (isset($active_tab) && $active_tab == 'resources')): ?><?php echo 'active'; ?><?php endif; ?>">
              ...
              <div class="collapsible">
                ...
                <div class="collapse-content collapse in" id="fonts">
                    ...
                    <?php echo $__env->make('voyager::compass.includes.fonts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          ...
          <div id="commands" class="tab-pane fade in <?php if($active_tab == 'commands'): ?><?php echo 'active'; ?><?php endif; ?>">
            ...
            <div id="command_lists">
                <?php echo $__env->make('voyager::compass.includes.commands', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
          ...
          <div id="logs" class="tab-pane fade in <?php if($active_tab == 'logs'): ?><?php echo 'active'; ?><?php endif; ?>">
            <div class="row">
                ...
                <?php echo $__env->make('voyager::compass.includes.logs', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('voyager::master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Codigos\turismo\laravel\vendor\tcg\voyager\src/../resources/views/compass/index.blade.php ENDPATH**/ ?>