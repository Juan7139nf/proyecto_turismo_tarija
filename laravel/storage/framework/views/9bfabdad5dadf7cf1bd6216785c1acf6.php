...
<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <li class="dd-item" data-id="<?php echo e($item->id); ?>">
        ...
        <?php if(!$item->children->isEmpty()): ?>
            <?php echo $__env->make('voyager::menu.admin', ['items' => $item->children], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
    </li>
...
<?php /**PATH D:\Codigos\turismo\laravel\vendor\tcg\voyager\src/../resources/views/menu/admin.blade.php ENDPATH**/ ?>