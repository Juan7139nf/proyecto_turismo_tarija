        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-2 text-gray-300">
              Descubre la magia de Tarija con nosotros. Ofrecemos las mejores experiencias turísticas
              en la región de los vinos y el buen clima.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tours" className="text-gray-300 hover:text-red-500 transition-colors duration-200">
                  Tours
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <span>info@tarijatours.com</span>
              </li>
              <li className="flex items-center">
                <svg className="h-5 w-5 mr-2 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>Calle Principal #123, Tarija</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Tarija Tours. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </div>
